 ...
 * This service handles the addition, removal, and updating of books in the
 * cart,
...
public interface ICartService {
     ...
     *
     * @param cartId The ID of the cart.
     * @return A list of CartItem objects representing the books and their
    ...
    /**
     * Adds a new book to the cart or updates the quantity if the book already
     * exists.
     * If the book is already present in the cart, its quantity is updated to the
     * new value.
     *
     * @param cartId   The ID of the cart.
