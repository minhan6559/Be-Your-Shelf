 ...
 * It displays the top 5 best-selling books and provides an interface for the
 * user to interact with the shopping cart.
 */
public class UserDashboardController extends BookTableController {
    ...
    /**
     * Initializes the controller by setting up the table and loading the
     * top-selling books.
    ...
    public void initialize() {
        ...
        UIUtils.loadCSS(topBooksTableView, "/com/beyourshelf/css/table-style.css");
        ...
        initializeBookTable(topBooksTableView, topTitleColumn, topAuthorColumn, topPriceColumn, topStockColumn,
                topSoldCopiesColumn, topActionColumn);
    }
    ...
    /**
     * Sets the logged-in user's first and last name and updates the welcome message
     * accordingly.
     *
    ...
    /**
     * Sets the user's shopping cart and passes it to the parent class for further
     * handling.
     *
