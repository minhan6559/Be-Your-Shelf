...
public class AdminStockController {
    ...
    public void initialize() {
        ...
        loadBooks();
        UIUtils.loadCSS(bookTableView, "/com/beyourshelf/css/table-style.css");
    }
            ...
            public TableCell<Book, Void> call(final TableColumn<Book, Void> param) {
                return new TableCell<>() {
                    ...
                    private Button createRemoveButton() {
                        ...
                        button.setStyle(
                                "-fx-background-color: #ff4500; -fx-text-fill: white; -fx-border-radius: 15; -fx-padding: 8 15;");
                        button.setOnAction(_ -> {
                            Book book = getTableView().getItems().get(getIndex());
    ...
    private void handleEditBook(Book book) {
        UIUtils.loadModal("/com/beyourshelf/fxml/admin/admin_edit_book.fxml", "Edit Book", controller -> {
    ...
    /**
     * Handles the Remove Book action by confirming the removal and deleting the
     * book.
     *
    ...
    /**
     * Handles the search functionality by filtering books based on the search
     * keyword.
     */
    @FXML
    ...
    /**
     * Handles updating the stock of a specific book based on the entered Book ID
     * and new stock value.
     * Directly adjusts the stock (replaces the value rather than adding or
     * subtracting).
     */
    @FXML
    ...
    public void handleAddBook() {
        UIUtils.loadModal("/com/beyourshelf/fxml/admin/admin_add_book.fxml", "Add New Book", controller -> {
