...
import com.beyourshelf.controller.user.EditProfileController;
 ...
 * Provides navigation to various admin features like managing stocks, orders,
 * users, editing profile, and logout.
 */
public class AdminSidebarController {
    ...
    public void handleViewStocks() {
        loadSceneWithoutData("/com/beyourshelf/fxml/admin/admin_view_stocks.fxml", "Manage Stocks");
    }
    ...
    public void handleViewManageOrders() {
        loadSceneWithoutData("/com/beyourshelf/fxml/admin/admin_manage_orders.fxml", "Manage All Orders");
    }
    ...
    public void handleViewManageUsers() {
        loadSceneWithoutData("/com/beyourshelf/fxml/admin/admin_manage_users.fxml", "Manage Users");
    }
    ...
    public void handleEditProfile() {
        UIUtils.loadSceneWithData("/com/beyourshelf/fxml/admin/admin_edit_profile.fxml", getCurrentStage(),
