package com.beyourshelf.model.dao;
 ...
 * It encapsulates the basic methods for interacting with the database, ensuring
 * consistent handling of connections.
 */
public abstract class BaseDAO {
     ...
     * @return boolean indicating if the operation was successful (true if rows
     *         affected > 0)
     */
    ...
    /**
     * Execute a SQL query and map the ResultSet to a desired object type using the
     ...
     * This is useful for inserting or updating multiple rows at once in a single
     * operation.
     *
     * @param sql        The SQL statement to execute.
     * @param paramsList A list of parameter arrays, where each array corresponds to
     *                   the parameters for one statement.
     * @return boolean indicating if the batch operation was successful (true if
     ...
     * This method abstracts the repetitive process of setting prepared statement
     * parameters.
     *
