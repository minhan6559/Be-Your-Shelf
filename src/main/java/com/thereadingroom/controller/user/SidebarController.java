 ...
 * Provides navigation to various sections like books, user dashboard, orders, cart, and profile management.
 */
public class SidebarController {
    ...
    private void setupUserDashboardController(UserDashboardController controller, ShoppingCart shoppingCart) {
        controller.setUser(SessionManager.getInstance().getFirstName(), SessionManager.getInstance().getLastName());  // Set the user's name
    ...
    public void handleViewOrders() {
        loadSceneWithController("/com/thereadingroom/fxml/user/view_orders.fxml", "Your Orders", SessionManager.getInstance().getUserId());
    }
    ...
    public void handleEditProfile() {
        UIUtils.loadSceneWithData("/com/thereadingroom/fxml/user/edit_profile.fxml", getCurrentStage(), "Edit Profile", controller -> {
            ...
            profileController.setUserService(ServiceManager.getInstance().getUserService());  // Inject the user service
        });
    }
    ...
    public void handleLogout() {
        ...
        UIUtils.loadSceneWithData("/com/thereadingroom/fxml/common/login.fxml", getCurrentStage(), "Login", controller -> {
            ...
            loginController.setUserService(ServiceManager.getInstance().getUserService());  // Inject the user service
        });
    }
