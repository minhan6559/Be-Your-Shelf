...
public class LoginController {
    ...
    private void redirectToAdminDashboard(User user) {
        UIUtils.loadSceneWithData("/com/thereadingroom/fxml/admin/admin_view_stocks.fxml", getStage(),
    ...
    private void initializeUserDashboard(User user) {
        ...
        UIUtils.loadSceneWithData("/com/thereadingroom/fxml/user/user_dashboard.fxml", getStage(), "User Dashboard",
                controller -> {
    ...
    public void handleRegister() {
        UIUtils.loadSceneWithData("/com/thereadingroom/fxml/common/register.fxml", getStage(), "User Registration",
                controller -> {
