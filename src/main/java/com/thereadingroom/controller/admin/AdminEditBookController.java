...
public class AdminEditBookController {
     ...
     * details to the controller, which then populates the form fields with the book's current information.
     *
    ...
    /**
     * Handles the cancel button action. It closes the window without saving any changes.
     */
    @FXML
