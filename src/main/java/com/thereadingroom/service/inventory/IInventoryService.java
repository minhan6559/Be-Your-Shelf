 ...
 * including reserving books, reverting reservations, and finalizing stock adjustments.
 */
public interface IInventoryService {
    ...
    /**
     * Revert previously reserved stock for the provided cart items. This is useful in case of payment failure or cancellation.
     *
    ...
    /**
     * Finalize stock adjustments for the purchased books, reducing stock and updating the number of sold copies.
     *
