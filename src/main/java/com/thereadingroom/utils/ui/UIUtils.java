...
public class UIUtils {
    ...
    /**
     * Loads a modal window (blocks interaction with other windows) using the specified FXML file.
     ...
     *
     * @param root    The root node (scene or parent) where the stylesheet will be applied.
